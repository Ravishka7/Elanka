...
<div
  class="block max-w-[18rem] rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-800">
  
  <div class="p-6">
    <h1
      class="mb-2 text-xl font-large leading-tight text-neutral-800 dark:text-neutral-50">
      Student Details
    </h1>
  </div>
  <ul class="w-full">
    <li
      class="w-full border-b-2 border-neutral-100 border-opacity-100 px-6 py-3 dark:border-opacity-50 text-x2 font-medium leading-tight text-neutral-800 dark:text-neutral-50">
  ...
  <div class="p-6">
    ...
    <form action="{{ route('students.destroy', ['student' => $student->id]) }}" method="POST">
        @csrf
        @method('DELETE')
        <button type="submit">Delete the record</button>
    </form>
  </div>
</div>
</div>
