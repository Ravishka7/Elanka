                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Science</td>
                          <td>
                            <div class="badge badge-inverse-success"> Marked </div>
                          </td>
                          <td>35</td>
                        </tr>
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="table-user-name ml-3">
                                <p class="mb-0 font-weight-medium">  Science 2021 MCQ Paper </p>
                              </div>
                            </div>
                          </td>
                          <td>Science</td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="badge badge-inverse-danger"> Not Marked </div>
                          </td>
                          <td>50</td>
                        </tr>
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="table-user-name ml-3">
                                <p class="mb-0 font-weight-medium"> Health Science 2023 MCQ Paper </p>
                              </div>
                            </div>
                          </td>
                          <td>Health Science & Studies</td>
                          <td>
                            <div class="badge badge-inverse-success"> Maerked </div>
                          </td>
                          <td>45</td>
                        </tr>
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="table-user-name ml-3">
                                <p class="mb-0 font-weight-medium"> Scence 2020 Past Paper </p>
                              </div>
                            </div>
                          </td>
                          <td>Science</td>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="table-user-name ml-3">
                                <p class="mb-0 font-weight-medium"> Science 2021 Past Paper </p>
                              </div>
                            </div>
                          </td>
                          <td>Science</td>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                    <div class="pt-2">
                      <h5 class="mb-0">Science</h5>
                      <p class="mb-0 text-muted">9C</p>
                      <h6 class="mb-0">9.30 - 10.15am</h6>
                    </div>
                  </div>
                  <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                    <div class="pt-2">
                      <h5 class="mb-0">Health Science & Studies</h5>
                      <p class="mb-0 text-muted">10D</p>
            ...
            <div class="col-xl-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="text-muted">Created by teacher001</p>
                ...
                <div class="card-body">
                  ...
                  <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                    ...
                    <div class="col-sm-3 pl-0 pl-sm-3">
                      <div class="badge badge-inverse-success mt-3 mt-sm-0"> 100% </div>
                    </div>
                  </div>
                  <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                    <div class="col-sm-9 pl-0">
